...
export const BlankPage: React.FC<BlankPageProps> = ({ pageNumber, showKdpGuides = false, isPdfMode = false }) => {
  return (
    <div
      ...
      className={
        isPdfMode
          ...
          : "print-page relative w-full bg-white overflow-hidden shadow-sm rounded-xl mx-auto flex flex-col justify-between text-slate-800 p-8 select-none border border-slate-100"
      }
      style={
        isPdfMode
